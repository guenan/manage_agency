...
public class DAOFactory {
    ...
    public static Objet_Connection getInformation() throws DAOConfigurationException {
        Properties properties = new Properties();
        String url;
        String driver;
        String nomUtilisateur;
        ...
        Objet_Connection instance = new Objet_Connection( url, nomUtilisateur, motDePasse );
        return instance;
    }
